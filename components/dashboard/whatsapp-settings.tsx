...
export function WhatsAppSettings() {
  const [callCenter, setCallCenter] = React.useState<ContactSetting | null>(
    null,
  );
      ...
      <Card>
        <CardHeader>
          <div className="flex items-start justify-between">
            <div>
              ...
              <CardDescription>
                Nomor WhatsApp untuk pertanyaan umum sekolah (Orang Tua, Wali
                Murid, Tamu)
              </CardDescription>
            </div>
        ...
        <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  size="icon"
                  onClick={() =>
                    copyToClipboard(callCenter?.phoneNumber || "", "Nomor")
                  }
                >
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">
              Template ini akan otomatis muncul saat pengguna klik tombol
              WhatsApp
            </p>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h4 className="font-semibold text-blue-900 mb-2">
                Cara Menggunakan Call Center WhatsApp:
              </h4>
              <ul className="space-y-1 text-sm text-blue-800">
                <li>
                  • <strong>Call Center</strong>: Untuk pertanyaan umum sekolah
                  (Orang Tua, Wali Murid, Tamu)
                </li>
                <li>
                  • Nomor ini akan digunakan di halaman{" "}
                  <strong>Contact Us</strong> dan footer website
                </li>
                <li>
                  • Template pesan akan otomatis muncul saat pengguna klik
                  tombol WhatsApp
                </li>
                <li>
                  • Gunakan tombol "Test WhatsApp" untuk melihat preview pesan
                </li>
                <li>• Nomor harus dalam format internasional (628xxx...)</li>
                <li>
                  • Untuk <strong>Bantuan SPMB</strong>, silakan atur di menu{" "}
                  <strong>Dashboard → Admissions → WhatsApp</strong>
                </li>
              </ul>
            </div>
          </div>
