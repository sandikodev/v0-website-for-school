...
test.describe("Signup Form - Complete Flow", () => {
  test("should complete full registration process", async ({ page }) => {
    ...
    await expect(
      page.locator('h1:has-text("Formulir Pendaftaran")'),
    ).toBeVisible();
    ...
    await page.fill(
      "textarea#prestasi",
      "Juara 1 Olimpiade Matematika Tingkat Kecamatan 2023",
    );
    ...
    await page.screenshot({
      path: "tests/screenshots/before-submit.png",
      fullPage: true,
    });
    ...
    await page.screenshot({
      path: "tests/screenshots/success.png",
      fullPage: true,
    });
  ...
  test("submit button should be disabled without checkbox", async ({
    page,
  }) => {
    await page.goto("http://localhost:3000/signup");
