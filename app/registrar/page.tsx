        ...
        <div className="grid md:grid-cols-3 gap-4 mb-6 no-print">
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="font-semibold text-yellow-900">Status: Pending</p>
            </div>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="font-semibold text-green-900">Status: Diterima</p>
            </div>
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="font-semibold text-red-900">Status: Ditolak/Masalah</p>
            </div>
