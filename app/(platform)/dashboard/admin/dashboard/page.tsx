  ...
  facilities: [
    {
      id: 1,
      name: "Masjid",
      description: "Masjid untuk kegiatan ibadah dan pembelajaran agama",
      status: "Tersedia",
    },
    {
      id: 2,
...
export default function AdminDashboard() {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- TODO: type auth user shape
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- chart payload not typed
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium text-gray-900">
              {schoolData.profile.foundedYear}
            </span>
          </div>
          <div className="flex justify-between">
