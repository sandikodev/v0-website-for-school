...
export default function SchoolPage() {
  ...
  const fetchSchool = async () => {
    try {
      ...
      console.error("Error fetching school:", _error);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage({
          type: "error",
          text: data.message || "Gagal memperbarui data sekolah",
        });
      }
    } catch (_error) {
      setMessage({
      ...
      console.error("Error saving school:", _error);
    } finally {
      setIsSaving(false);
    }
  };
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">
                      Upload logo ke hosting image kemudian paste URL-nya di
                      sini
                    </p>
                  </div>
                </CardContent>
            ...
            <TabsContent value="contact" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Detail kontak dan lokasi sekolah
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  {/* Alamat */}
