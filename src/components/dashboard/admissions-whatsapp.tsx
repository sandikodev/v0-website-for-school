...
export function AdmissionsWhatsApp() {
  const [admissions, setAdmissions] = React.useState<ContactSetting | null>(
    null,
  );
  ...
  const testWhatsApp = () => {
    ...
    const url = generateWhatsAppUrl(
      admissions.phoneNumber,
      admissions.waTemplate,
    );
        ...
        <CardHeader>
          <div className="flex items-start justify-between">
            <div>
              ...
              <CardDescription>
                Nomor WhatsApp khusus untuk bantuan pendaftaran dan penerimaan
                peserta didik baru
              </CardDescription>
            </div>
            <Badge
              variant={admissions?.isActive ? "default" : "secondary"}
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Format: 628xxx (dengan kode negara Indonesia)
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Teks yang muncul di tombol WhatsApp
              </p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) =>
                setAdmissions((prev) =>
                  prev ? { ...prev, waTemplate: e.target.value } : null,
                )
              }
            ...
            <div className="flex items-start gap-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div className="text-xs text-blue-800">
                <p className="font-semibold mb-1">
                  Template ini akan otomatis muncul saat calon pendaftar klik
                  tombol WhatsApp
                </p>
                <ul className="space-y-0.5 ml-4">
                  ...
                  <li>
                    • Sertakan field penting: Nama, Nomor Pendaftaran,
                    Pertanyaan
                  </li>
                </ul>
              </div>
        ...
        <CardContent className="space-y-3">
          <div className="bg-white p-3 rounded-lg border border-emerald-200">
            ...
            <p className="text-sm font-mono break-all text-emerald-700">
              {getWhatsAppUrl() ||
                "Lengkapi nomor WhatsApp untuk melihat preview"}
            </p>
          </div>
          <div className="bg-white p-3 rounded-lg border border-emerald-200">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h4 className="font-semibold text-blue-900 mb-2">
                Cara Penggunaan WhatsApp SPMB:
              </h4>
              <ul className="space-y-1 text-sm text-blue-800">
                <li>
                  • Nomor ini akan otomatis digunakan di halaman{" "}
                  <strong>/admissions</strong>
                </li>
                <li>
                  • Tombol "Bantuan SPMB" akan muncul di banner dan footer
                  halaman pendaftaran
                </li>
                <li>
                  • Calon pendaftar yang klik tombol akan langsung diarahkan ke
                  WhatsApp dengan template pesan
                </li>
                <li>
                  • Template pesan akan otomatis terisi, memudahkan calon
                  pendaftar berkomunikasi
                </li>
                <li>
                  • Pastikan nomor WhatsApp aktif dan siap menerima pesan 24/7
                </li>
                <li>
                  • Format nomor harus:{" "}
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <div className="space-y-2">
              ...
              <ul className="space-y-1 text-gray-600">
                ...
                <li>
                  • Sediakan field untuk nomor pendaftaran (jika sudah daftar)
                </li>
            ...
            <div className="space-y-2">
              <p className="font-semibold text-destructive">❌ Yang Dihindari:</p>
              <ul className="space-y-1 text-gray-600">
