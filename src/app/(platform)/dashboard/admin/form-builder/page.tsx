...
export default function FormBuilderPage() {
  const [formName, setFormName] = React.useState(
    "Formulir Pendaftaran 2025/2026",
  );
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            The signup form currently uses a fixed structure with the following
            sections
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-blue-800 mb-3">
                The current form structure is working well for the registration
                process. A full drag-and-drop form builder with custom fields is
