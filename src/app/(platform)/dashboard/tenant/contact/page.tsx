          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Informasi kontak utama sekolah
                </CardDescription>
              </CardHeader>
              <CardContent className="grid gap-4 md:grid-cols-2">
                ...
                <div className="grid gap-2 md:col-span-2">
                  ...
                  <Input
                    ...
                    placeholder="0812-3456-7890 (24 Jam)"
                  />
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Kontak person untuk berbagai keperluan
                </CardDescription>
              </CardHeader>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="Dr. Ahmad Fauzi, M.Pd - 0812-3456-7891"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="vice-principal-contact">
                      Wakil Kepala Sekolah
                    </Label>
                    <Input
                      id="vice-principal-contact"
                      placeholder="Siti Rahma, S.Pd - 0812-3456-7892"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="curriculum-contact">
                      Koordinator Kurikulum
                    </Label>
                    <Input
                      id="curriculum-contact"
                      placeholder="Budi Setiawan, M.Pd - 0812-3456-7893"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="student-affairs-contact">Kesiswaan</Label>
                    <Input
                      id="student-affairs-contact"
                      placeholder="Fatimah Az-Zahra, S.Pd - 0812-3456-7894"
                    />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="admission-contact">
                      Penerimaan Siswa Baru
                    </Label>
                    <Input
                      id="admission-contact"
                      placeholder="Muhammad Yusuf, S.Pd - 0812-3456-7895"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      id="finance-contact"
                      placeholder="Ahmad Rizki, S.E - 0812-3456-7896"
                    />
                  </div>
                </div>
              </CardContent>
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-6">
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="break-time"
                      placeholder="09:30 - 10:00 & 12:00 - 12:30"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      id="prayer-time"
                      placeholder="Dzuhur: 12:00, Ashar: 15:30"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input
                        id="monday-friday"
                        placeholder="07:00 - 15:00 (Kegiatan Belajar)"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        id="saturday"
                        placeholder="07:00 - 12:00 (Ekstrakurikuler)"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        id="sunday"
                        placeholder="Libur (Kecuali Kegiatan Khusus)"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        id="holidays"
                        placeholder="Mengikuti Kalender Pendidikan"
                      />
                    </div>
                  </div>
                </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Jadwal kegiatan khusus dan acara
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="upacara"
                      placeholder="Setiap Senin, 07:00 - 08:00"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      id="meeting"
                      placeholder="Setiap Jumat, 15:00 - 16:00"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      id="parent-meeting"
                      placeholder="Setiap Bulan, Sabtu 08:00 - 12:00"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      id="exam-period"
                      placeholder="Jadwal Khusus (Diumumkan)"
                    />
                  </div>
                </div>
              </CardContent>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Akun media sosial dan platform online sekolah
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input
                        id="e-learning"
                        placeholder="https://elearning.smp-syuhada.sch.id"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        id="student-portal"
                        placeholder="https://portal.smp-syuhada.sch.id"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        id="parent-portal"
                        placeholder="https://ortu.smp-syuhada.sch.id"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input
                        id="teacher-portal"
                        placeholder="https://guru.smp-syuhada.sch.id"
                      />
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Alamat dan informasi lokasi sekolah
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid gap-4 md:grid-cols-2">
