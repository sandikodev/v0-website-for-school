...
const AdmissionsContent = () => {
  ...
  const [admissionsWA, setAdmissionsWA] = React.useState<{
    phoneNumber: string;
    waUrl: string;
    label: string;
  } | null>(null);
  const [callCenterWA, setCallCenterWA] = React.useState<{
    phoneNumber: string;
    waUrl: string;
    label: string;
  } | null>(null);
      ...
      .then(([admissionsData, callCenterData, spmbData]) => {
        ...
        if (admissionsData.data) {
          setAdmissionsWA({
            ...
            waUrl: generateWhatsAppUrl(
              admissionsData.data.phoneNumber,
              admissionsData.data.waTemplate,
            ),
        ...
        if (callCenterData.data) {
          setCallCenterWA({
            ...
            waUrl: generateWhatsAppUrl(
              callCenterData.data.phoneNumber,
              callCenterData.data.waTemplate,
            ),
            ...
            {isLoading ? (
              ...
              <>
                <h1 className="text-4xl font-bold mb-4">
                  {spmb?.heroTitle || "SPMB SMP IT MASJID SYUHADA"}
                </h1>
                <p className="text-xl mb-2">
                  {spmb?.heroSubtitle || "TAHUN PELAJARAN 2025/2026"}
                </p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-700 mb-4">
                  Jika Anda telah menyelesaikan pendaftaran online, Anda dapat
                  memantau status pendaftaran Anda kapan saja menggunakan nomor
                  pendaftaran yang telah Anda terima.
                </p>
                ...
                <div className="bg-white rounded-lg p-4 mb-4 border border-emerald-200">
                  ...
                  <ol className="space-y-2 text-sm text-gray-700 ml-7">
                    ...
                    <li>
                      2. Masukkan nomor pendaftaran Anda (contoh:
                      SPMB-2025-XXXX)
                    </li>
                    <li>
                      3. Lihat status terkini pendaftaran Anda dan keterangan
                      lengkap
                    </li>
                ...
                <div className="flex flex-col sm:flex-row flex-wrap gap-3">
                  ...
                  <Link href="/signup" className="order-1">
                    <Button
                      size="lg"
                      className="w-full sm:w-auto bg-linear-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white shadow-lg hover:shadow-xl transition-all duration-300 animate-pulse-subtle hover:scale-105 active:scale-95"
                    >
                  ...
                  >
                    ...
                    >
                      ...
                      <span suppressHydrationWarning>
                        {isLoading
                          ? "Loading..."
                          : admissionsWA?.label || "Bantuan SPMB"}
                      </span>
                    </Button>
                  </a>
                </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <Tabs value={current} onValueChange={setTab} className="space-y-8">
          ...
          <TabsContent value="gelombang" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Periode pendaftaran dibagi menjadi beberapa gelombang dengan
                  potongan biaya yang berbeda
                </CardDescription>
              </CardHeader>
              <CardContent>
                {isLoading ? (
                        ...
                        return (
                          ...
                          >
                            <CardHeader className="pb-3">
                              <Badge className={`w-fit ${colors.bg}`}>
                                {gelombang.badge}
                              </Badge>
          ...
          <TabsContent value="jalur" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Tersedia jalur reguler dan jalur prestasi dengan keunggulan
                  masing-masing
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <Card className="border-2 border-gray-200">
                    ...
                    <CardContent>
                      <p className="text-gray-600">
                        Jalur pendaftaran umum untuk semua calon siswa yang
                  ...
                  <Card className="border-2 border-emerald-200 bg-emerald-50">
                    <CardHeader>
                      ...
                      <Badge className="w-fit bg-emerald-600">
                        Dana pengembangan hanya Rp 1.000.000
                      </Badge>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Ranking 1-3 di kelas 4, 5, 6 SD (dibuktikan dengan
                          surat pernyataan)
                        </p>
                      </div>
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Dibuktikan dengan sertifikat kejuaraan lomba
                        </p>
                      </div>
                      <div>
                        <h4 className="font-semibold text-emerald-700 mb-2">
                        ...
                        <p className="text-sm text-gray-600">
                          Hafal 3 juz Al-Quran (dibuktikan dengan sertifikat dan
                          tes)
                        </p>
                      </div>
                    </CardContent>
          ...
          <TabsContent value="biaya" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Struktur biaya pendidikan di SMP IT Masjid Syuhada
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-blue-700 mt-1 space-y-1">
                        <li>
                          • Dana pengembangan dapat diangsur selama 1 semester
                          (2-3 kali angsuran)
                        </li>
                        <li>• SPP sudah termasuk catering</li>
                        <li>
                          • Biaya tambahan untuk ekstrakurikuler Robotika dan
                          Futsal
                        </li>
                      </ul>
                    </div>
          ...
          <TabsContent value="syarat" className="space-y-6">
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-emerald-600 rounded-full mt-2"></div>
                      <p className="text-sm">
                        Fotokopi Ijazah dan Surat Keterangan Nilai ASPD yang
                        dilegalisir (gelombang 3)
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-emerald-600 rounded-full mt-2"></div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="space-y-2 text-sm text-gray-600">
                        <p>
                          <strong>Diniyah:</strong> Praktek Ibadah, Membaca
                          Al-Quran, Hafalan Surat-surat pendek
                        </p>
                        <p>
                          <strong>Kesiswaan:</strong> Pembiasaan/keseharian anak
                          dan identifikasi potensi
                        </p>
                      </div>
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Tentang pembayaran administrasi keuangan
                      </p>
                    </div>
                    <div className="p-3 bg-emerald-50 rounded-lg border border-emerald-200">
                      <p className="text-sm text-emerald-700">
                        <strong>Catatan:</strong> Bacaan Quran dan hafalan tidak
                        menjadi patokan lolos/tidaknya, hanya untuk pemetaan
                        siswa.
                      </p>
                    </div>
                  </div>
            ...
            <div className="mt-6 p-4 bg-linear-to-r from-emerald-50 to-blue-50 rounded-lg border border-emerald-200">
              <p className="text-center text-sm text-gray-700">
                💡 <strong>Siap mendaftar?</strong> Klik tombol{" "}
                <span className="text-emerald-600 font-semibold">
                  &quot;Daftar Baru&quot;
                </span>{" "}
                di atas untuk memulai pendaftaran online, atau hubungi tim kami
                untuk bantuan.
              </p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="faq" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Pertanyaan yang paling sering ditanyakan seputar PPDB SMP IT
                  Masjid Syuhada
                </CardDescription>
              </CardHeader>
              <CardContent>
                <Accordion type="single" collapsible className="space-y-2">
                    ...
                    <AccordionContent>
                      <div className="space-y-3 text-sm">
                        <p className="font-semibold text-emerald-900">
                          Setelah mendaftar online, Anda akan menerima nomor
                          pendaftaran (contoh: SPMB-2025-XXXX):
                        </p>
                        ...
                        <p className="text-emerald-800 bg-emerald-100 p-2 rounded">
                          💡 <strong>Tips:</strong> Simpan nomor pendaftaran.
                          Cek status berkala setiap 1-2 hari kerja.
                        </p>
                      </div>
                    </AccordionContent>
                  </AccordionItem>
                    ...
                    <AccordionContent>
                      <div className="space-y-2 text-sm">
                        ...
                        <ul className="list-disc list-inside space-y-1 ml-2">
                          <li>
                            <strong>Hari 1:</strong> Status{" "}
                            <span className="text-yellow-600 font-semibold">
                              Pending
                            </span>
                          </li>
                          <li>
                            <strong>Hari 1-2:</strong> Status{" "}
                            <span className="text-blue-600 font-semibold">
                              Ditinjau
                            </span>
                          </li>
                          <li>
                            <strong>Hari 2-3:</strong> Status{" "}
                          ...
                          <li>
                            <strong>Hari 3-5:</strong> Tim menghubungi via
                            WA/Email
                          </li>
                        </ul>
                        <p className="text-blue-800 bg-blue-100 p-2 rounded mt-2">
                          📞 Belum ada kabar setelah 3 hari? Hubungi: 0858 7895
                          8029
                        </p>
                      </div>
                    </AccordionContent>
                    ...
                    <AccordionContent>
                      <div className="space-y-3 text-sm">
                        ...
                        <p className="text-yellow-800 bg-yellow-100 p-2 rounded mt-2">
                          ✅ Solusi cepat: Masalah biasanya selesai dalam 1 hari
                          kerja!
                        </p>
                      </div>
                    </AccordionContent>
                  ...
                  <AccordionItem value="item-1">
                    <AccordionTrigger>
                      Bagaimana tata cara pendaftaran siswa baru?
                    </AccordionTrigger>
                    <AccordionContent>
                      <ol className="list-decimal list-inside space-y-2 text-sm">
                        <li>Membayar uang pendaftaran Rp. 100.000</li>
                        <li>
                          Mengisi formulir pendaftaran dengan melengkapi
                          fotokopi akta lahir dan kartu keluarga
                        </li>
                        <li>
                          Mengikuti sesi wawancara (diniyah, kepribadian,
                          keuangan)
                        </li>
                        <li>
                          Setelah dinyatakan lolos, membayar administrasi wajib
                        </li>
                        <li>
                          Mengambil kain seragam (jika sudah lunas administrasi
                          wajib)
                        </li>
                        <li>
                          Dana Pengembangan dapat dibayarkan setelah masuk
                          sekolah dan boleh diangsur
                        </li>
                      </ol>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-2">
                    <AccordionTrigger>
                      Apakah belum bisa Quran dan belum hafal juz 30 tetap dapat
                      lolos masuk?
                    </AccordionTrigger>
                    <AccordionContent>
                      <p className="text-sm">
                        Ya, bacaan Quran dan hafalan yang dimiliki tidak menjadi
                        patokan lolos atau tidaknya siswa. Hal ini hanya menjadi
                        pemetaan siswa untuk penempatan kelas yang sesuai.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-3">
                    <AccordionTrigger>
                      Berapa kelas yang dibuka setiap angkatan?
                    </AccordionTrigger>
                    <AccordionContent>
                      <p className="text-sm">
                        Total setiap angkatan ada 4 kelas: 2 kelas putra dan 2
                        kelas putri. Kelas putra dan putri dipisah sesuai dengan
                  ...
                  <AccordionItem value="item-4">
                    <AccordionTrigger>
                      Jam berapa mulai KBM dan pulangnya?
                    </AccordionTrigger>
                    <AccordionContent>
                      <p className="text-sm">
                        Jam masuk sekolah adalah 7.00 WIB, dimulai dengan sholat
                        dhuha dan dzikir pagi di masjid Syuhada, kemudian
                        dilanjutkan dengan KBM. Pulang sekolah pukul 14.30 WIB
                        jika tidak ada kegiatan tambahan (ekstrakurikuler atau
                        kegiatan diniyah).
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="item-5">
                    <AccordionTrigger>
                      Apakah siswa diperkenankan membawa HP?
                    </AccordionTrigger>
                    <AccordionContent>
                      <p className="text-sm">
                        Siswa tidak boleh membawa HP ke sekolah. Untuk keperluan
                        penjemputan, dapat menghubungi wali kelas atau satpam
                        sekolah. Jika ada keperluan mendesak dan harus membawa
                        HP, harus dengan izin dan dititipkan ke waka kesiswaan
                        sampai pulang.
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                    ...
                    <AccordionContent>
                      <div className="space-y-3 text-sm">
                        ...
                        <div>
                          ...
                          <p>
                            Qiro&apos;ah, Murottal, Adzan, Kaligrafi, Pidato,
                            Rebana, Acapella
                          </p>
                        </div>
                        <div>
                          <p className="font-semibold">
                            Ekstrakurikuler Umum Pilihan:
                          </p>
                          <p>
                            Film Maker, Tari Tradisional, Nasyid Vocal, KIR,
                            Robotika, Multimedia, OSN, Futsal, Bulutangkis,
                            Jemparingan, Pencak Silat
                          </p>
                        </div>
                      </div>
                    </AccordionContent>
                  ...
                  <AccordionItem value="item-7">
                    ...
                    <AccordionContent>
                      <div className="space-y-2 text-sm">
                        <p>
                          • Program Perbaikan Baca Alquran dengan metode
                          Tilawati
                        </p>
                        <p>
                          • Hafalan/Tahfidz Alquran, baik yang reguler maupun
                          intensif (takhosus)
                        </p>
                      </div>
                    </AccordionContent>
                  ...
                  <AccordionItem value="item-8">
                    <AccordionTrigger>
                      Apakah sekolah menerima siswa pindahan dari luar kota?
                    </AccordionTrigger>
                    <AccordionContent>
                      <p className="text-sm">
                        Ya, kami menerima siswa pindahan dari luar kota. Untuk
                        tata cara mengurus siswa pindah/mutasi masuk, langsung
                        hubungi Bu Ning/WA Center (0858 7895 8029).
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
        ...
        <Card className="mt-8 bg-linear-to-r from-emerald-600 to-emerald-700 text-white">
          <CardContent className="p-6">
                ...
                >
                  ...
                  >
                    ...
                    <span suppressHydrationWarning>
                      {isLoading
                        ? "Loading..."
                        : callCenterWA?.label || "Call Center"}
                    </span>
                  </Button>
                </a>
                <Button
...
const SMPBPage = () => (
  <React.Suspense fallback={<p>Loading...</p>}>
    {/* fixed: isolate search-param hook usage within suspense boundary */}
    <AdmissionsContent />
  </React.Suspense>
);

export default SMPBPage;
