          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="text-center">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Kami siap membantu Anda dengan informasi tentang pendaftaran,
                program, dan segala hal tentang SMP IT Masjid Syuhada
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-lg text-muted-foreground">
                    Kami siap membantu Anda dengan informasi tentang SMP IT
            ...
            <Card className="mt-8 bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                  ...
                  pendaftaran, kurikulum, fasilitas, dan informasi lainnya.
                </p>
                <CTASection />
              </CardContent>
            </Card>
